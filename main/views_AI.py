...
def AI_trader_3_get_data(request):
    ...
    with open(f'{base_path}/2_AI_APPO_LS_stock_ver2/traj/backtest_result.json', 'r') as file:
        for line in file:
            data.append(json.loads(line.strip()))
...
def AI_trader_4_get_data(request):
    ...
    with open(f'{base_path}/2_AI_APPO_LS_stock_3/traj/backtest_result.json', 'r') as file:
        for line in file:
            data.append(json.loads(line.strip()))
